...
public class TopStoryAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mContextWR.get()).inflate(
					R.layout.fragment_top_story, null);
			holder.imageView = (ImageView) convertView
					.findViewById(R.id.iv_story_image);
	...
	private void setupFlowView(ViewHolder holder, int position) {
		...
		Picasso.with(mContextWR.get()).load(model.getImage())
				.placeholder(R.drawable.ic_header).fit().centerCrop()
